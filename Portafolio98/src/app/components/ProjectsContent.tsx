      ...
      {projects.map((project, index) => (
        ...
        >
          ...
          <div className="p-4 space-y-3">
            {/* Preview image in Win98 bordered container */}
            <div className="border-2 border-[#808080] border-t-[#dfdfdf] border-l-[#dfdfdf] border-r-[#404040] border-b-[#404040] bg-white p-1">
              <div className="border-2 border-[#808080] border-t-white border-l-white overflow-hidden">
                <img
                  src={project.image}
                  alt={project.name}
