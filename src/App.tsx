...
function Navbar() {
  ...
  return (
    <>
      ...
      {/* Ergonomic Floating Bottom Navigation Bar for Mobile (SVG icons, NO emojis) */}
      <nav
        className="md:hidden fixed bottom-0 left-0 right-0 z-50 px-2 py-1.5 flex justify-around items-center transition-all duration-300"
        style={{
          backgroundColor: 'rgba(22,35,42,0.96)',
        ...
        {[
          ...
          return (
            <button
              ...
              className="flex flex-col items-center justify-center py-1 px-2 rounded transition-all duration-200 cursor-pointer"
              style={{
                color: isActive ? '#FF5B04' : 'rgba(228,238,240,0.65)',
              }}
            >
              <div
              ...
              <span
                ...
                style={{
                  fontFamily: 'Barlow Condensed, sans-serif',
                  color: isActive ? '#FF5B04' : 'rgba(228,238,240,0.6)',
                }}
              >
                {item.label}
              </span>
          ...
          {[
            ...
            >
              ...
              <p
                ...
                style={{ color: 'rgba(228,238,240,0.88)', fontFamily: 'Barlow, sans-serif' }}
              >
                {item.desc}
              </p>
            </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <a
                  ...
                  className="font-semibold transition-colors duration-200 hover:text-[#FF5B04]"
            ...
            {/* Phone & WhatsApp item with dual action buttons */}
            <div className="flex items-start gap-4">
              <div
                className="w-10 h-10 flex items-center justify-center text-lg flex-shrink-0 mt-1"
                style={{ backgroundColor: 'rgba(22,35,42,0.4)', color: '#FF5B04', borderRadius: '2px' }}
              >
                ☎
              </div>
                ...
                <div className="flex gap-2 mt-1">
                  ...
                  <a
                    ...
                    style={{
                      ...
                      color: '#E4EEF0',
                      border: '1px solid rgba(228,238,240,0.2)',
                      fontFamily: 'Barlow Condensed, sans-serif',
                      borderRadius: '2px',
                    }}
                  >
