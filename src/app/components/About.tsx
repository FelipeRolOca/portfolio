...
export default function About({ t, language }: AboutProps) {
  ...
  return (
    <section id="about" ref={ref} className="py-20 px-6 bg-white dark:bg-gray-900 transition-colors duration-1000">
              ...
              >
                <CardTiltContent className="h-full">
                  <motion.div
                    ...
                    className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-[var(--yellow)] transition-all group h-full"
                  >
