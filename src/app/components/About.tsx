    ...
    <section id="about" className="py-24 bg-zinc-950 border-t border-zinc-900 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-12">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="relative min-h-[420px] lg:min-h-[540px]">
            ...
            <div className="relative flex h-full min-h-[420px] flex-col justify-between overflow-hidden rounded-[32px] p-6 sm:p-8">
              <div className="max-w-sm space-y-4">
                ...
                <p className="text-sm leading-relaxed text-zinc-400 sm:text-base">
                  {language === "es"
                    ? "Cada tarjeta resume una parte de cómo pienso, construyo y colaboro cuando llevo una idea a producción."
                    : "Each card captures a core part of how I think, build, and collaborate when turning an idea into production."}
                </p>
              </div>

              <div className="relative mt-10 h-[320px] sm:h-[360px] md:h-[400px]">
                <CardSwap
                  width={320}
                  height={228}
                  cardDistance={36}
                  ...
                  delay={4600}
                  pauseOnHover
                  className="origin-bottom-right scale-[0.88] sm:scale-100"
                >
                  {aboutCards.map((item) => {
                    const Icon = item.icon;

                    return (
                      <Card key={item.title} customClassName="w-full h-full">
                        ...
                        <div className="relative flex h-full flex-col justify-between p-6">
                          ...
                          <div className="flex items-center justify-between border-t border-zinc-800/80 pt-4 text-xs uppercase tracking-[0.2em] text-zinc-500">
                            ...
                            <span>{language === "es" ? "Sección About" : "About Section"}</span>
                          </div>
                        </div>
                      </Card>
                    );
