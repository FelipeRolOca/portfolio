      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <div className="overflow-hidden rounded-[2rem] border border-zinc-800/90 bg-zinc-900/50 shadow-xl">
              <div className="flex items-center gap-4 p-5 sm:p-6">
                ...
                <p className="text-lg font-bold text-white sm:text-xl">{t.contact.locationValue}</p>
              </div>

              <div className="relative h-72 overflow-hidden border-t border-zinc-800/80 sm:h-80">
                <img
                  src="/buenos_aires_neon_20260409_233022.png"
                  alt={locationMapAlt}
                  loading="lazy"
                  decoding="async"
                  className="absolute inset-0 h-full w-full object-cover object-[center_34%] opacity-80"
                />
                <div className="absolute inset-0 bg-gradient-to-b from-zinc-950/10 via-transparent to-zinc-950/60" />
              </div>
            </div>
