          ...
          {experiences.map((exp, idx) => (
            ...
            >
              ...
              <div className={`w-full md:w-1/2 pl-14 md:pl-0 ${idx % 2 === 0 ? "md:pr-14 md:text-right" : "md:pl-14 md:text-left"
                ...
                <div data-particle-target className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl hover:border-zinc-700 transition-colors shadow-lg shadow-black/20 relative overflow-visible group">
