...
export default function Hero({ t }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-white dark:bg-gray-900 transition-colors duration-1000">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
        ...
        >
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 dark:from-white dark:via-gray-200 dark:to-white bg-clip-text text-transparent"
          >
            {t.name}
          </motion.h1>
