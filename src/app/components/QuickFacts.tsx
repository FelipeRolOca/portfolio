          ...
          {quickFacts.map((fact, index) => (
            ...
            >
              <SpotlightCard
                ...
                className="h-full border-zinc-800/80 bg-zinc-900/65 backdrop-blur-sm transition-transform duration-300 hover:-translate-y-1"
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm sm:text-base font-semibold text-white leading-snug">{fact.value}</p>
                  </div>
                </div>
              </SpotlightCard>
            </motion.div>
